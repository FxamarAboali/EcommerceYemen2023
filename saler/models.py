...
class SalerDetail(models.Model):
	SEX_CHOICES = (("ذكر",'ذكر'),("انثى",'انثى'),("اخرى",'اخرى'))
	STATE_CHOICES = (
		("اليمن",'اليمن'),
...
class Product(models.Model):
	...
	category = models.ForeignKey(category, default="", verbose_name="الفئة", on_delete=models.SET_DEFAULT, null=True)
...
class WholeSaleProduct(models.Model):
	SEX_CHOICES = (("Male",'ذكر'),("Female",'انثى'),("All",'كل'))
	product_id = models.BigAutoField(primary_key=True)
	product_name = models.CharField(max_length=100)
	category = models.ForeignKey(category, default="", verbose_name="الفئة", on_delete=models.SET_DEFAULT)
	subcategory = models.CharField(max_length=50, default="")
	price = models.IntegerField(default=0)
	desc = models.TextField()
	size = models.TextField(verbose_name='الحجم المتاح (مفصولة بفاصلة)')
	color = models.TextField(verbose_name='أدخل اللون مفصولة بفاصلة')
...
class dow(models.Model):
	product = models.OneToOneField(Product, default="", verbose_name="رقم المنتج", on_delete=models.CASCADE, null=True)
